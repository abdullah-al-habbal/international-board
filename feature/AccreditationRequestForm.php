...
// filePath: app/Filament/Center/Resources/AccreditationRequests/Schemas/AccreditationRequestForm.php
...
class AccreditationRequestForm
{
    public static function configure(Schema $schema): Schema
    {
        ...
        return $schema
            ->columns(2)
            ->components([
                // Show center name as read-only context, hidden input carries the value.
                ...
                // ── Admin-only fields — shown read-only when viewing ────────
                // These are intentionally excluded from the create/edit form.
                // The infolist handles read-only display.
            ]);
    }
}
