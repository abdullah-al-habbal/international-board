<!-- resources\views\web\trainers\_filters.blade.php -->
<form action="{{ route('web.trainers.index') }}" method="GET" class="mb-5">
    <div class="row align-items-end">
        ...
        <div class="col-md-2 mt-2 mt-md-0">
            @if (request()->hasAny(['search', 'country_id', 'specialization']))
                <a href="{{ route('web.trainers.index') }}" class="btn btn-outline-secondary btn-block">
