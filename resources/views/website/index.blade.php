                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            <article class="col-lg-4 col-md-6">
                                <div class="post-item">
                                    <div class="media-wrapper">
                                        <img loading="lazy" src="{{ asset('assets/website/images/blog/post-1.jpg') }}" alt="amazing caves coverimage"
                                            class="img-fluid">
                                    </div>
                                    <div class="content">
                            ...
                            <article class="col-lg-4 col-md-6">
                                <div class="post-item">
                                    <div class="media-wrapper">
                                        <img loading="lazy" src="{{ asset('assets/website/images/blog/post-2.jpg') }}" alt="amazing caves coverimage"
                                            class="img-fluid">
                                    </div>
                                    <div class="content">
                            ...
                            <article class="col-lg-4 col-md-6">
                                <div class="post-item">
                                    <div class="media-wrapper">
                                        <img loading="lazy" src="{{ asset('assets/website/images/blog/post-3.jpg') }}" alt="amazing caves coverimage"
                                            class="img-fluid">
                                    </div>
                                    <div class="content">
                            ...
                            <div class="row justify-content-around">
                                ...
                                <div class="col-lg-3 col-md-6">
                                    <ul>
                                        ...
                                        <li><a
                                                href="https://www.youtube.com/channel/UCx9qVW8VF0LmTi4OF2F8YdA">Youtube</a>
                                        </li>
