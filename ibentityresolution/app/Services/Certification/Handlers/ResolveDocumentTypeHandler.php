...
/**
 * Document types are the smallest and most closed vocabulary of the four — usually
 * a couple of dozen rows. Same treatment as countries: exact ladder, quarantine on
 * miss, suggestions for a human, never an automatic merge.
 */
